...
const album1 = {
  ...
  const formats = ['CD', 'cassette', 'LP'];
  console.log(album6.albumDetails.formats);
  ...
  console.log(talkingHeadsAlbums[6].albumDetails.released.toLocaleDateString(5));
  ...
  console.log(talkingHeadsAlbums[4].albumDetails);
